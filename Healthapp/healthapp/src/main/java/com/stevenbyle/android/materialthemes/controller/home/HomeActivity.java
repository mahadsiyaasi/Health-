...
public class HomeActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter = new HomePagerAdapter(this,getSupportFragmentManager());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.activity_home_fab:
                SetThemeDialogFragment dialogFragment = SetThemeDialogFragment.newInstance(mCurrentTheme);
                DialogUtils.showDialogFragment(getFragmentManager(), dialogFragment);
