    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.fragment_material_theme_button_dialog_current_theme:
                MaterialThemeDialogFragment dialogFragment;

                /* DialogUtils.showDialogFragment(null, null, null, null); */
                break;
            ...
            case R.id.fragment_material_theme_button_dialog_green_theme:
                ...
                //DialogUtils.showDialogFragment(null, dialogFragment, generateFragmentTag(dialogFragment), onlyIfNotDuplicate);
                break;
